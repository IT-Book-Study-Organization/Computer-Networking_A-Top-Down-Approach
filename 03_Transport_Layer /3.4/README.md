...
- rdt2.0은 이러한 비트 손상 문제를 해결하기 위해 설계된 프로토콜로, 패킷의 **오류 감지**와 **재전송** 기능을 제공함.
...
- rdt2.0은 **오류 감지**, **긍정 응답(ACK)** 및 **부정 응답(NAK)** 을 사용하는 **Stop-and-Wait** 프로토콜임.
...
![Screenshot 2025-01-10 at 7 23 58 PM](https://github.com/user-attachments/assets/149c573e-ed99-46a0-88e6-57472bcfa405)
...
![Screenshot 2025-01-10 at 7 25 46 PM](https://github.com/user-attachments/assets/50ce2994-d05d-436a-85a4-50950d8eb18f)
